...
from sqlalchemy import Column, String, DateTime, ForeignKey, Boolean, Integer, ARRAY
...
class User(Base):
    ...
    role = Column(String(20), nullable=False)  # 'founder' or 'investor'
